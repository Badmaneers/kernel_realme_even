 ...
 **************************************************/
#define SEG_GPU_DVFS_FREQ_OC			(1200000)	/* KHz */
#define SEG_GPU_DVFS_FREQ0			(1100000)	/* KHz */
#define SEG_GPU_DVFS_FREQ1			(1070000)	/* KHz */
#define SEG_GPU_DVFS_FREQ2			(1040000)	/* KHz */
#define SEG_GPU_DVFS_FREQ3			(1010000)	/* KHz */
#define SEG_GPU_DVFS_FREQ4			(986000)	/* KHz */
#define SEG_GPU_DVFS_FREQ5			(957000)	/* KHz */
#define SEG_GPU_DVFS_FREQ6			(928000)	/* KHz */
#define SEG_GPU_DVFS_FREQ7			(897000)	/* KHz */
#define SEG_GPU_DVFS_FREQ8			(866000)	/* KHz */
#define SEG_GPU_DVFS_FREQ9			(836000)	/* KHz */
#define SEG_GPU_DVFS_FREQ10			(807000)	/* KHz */
#define SEG_GPU_DVFS_FREQ11			(776000)	/* KHz */
#define SEG_GPU_DVFS_FREQ12			(746000)	/* KHz */
#define SEG_GPU_DVFS_FREQ13			(715000)	/* KHz */
#define SEG_GPU_DVFS_FREQ14			(686000)	/* KHz */
#define SEG_GPU_DVFS_FREQ15			(656000)	/* KHz */
#define SEG_GPU_DVFS_FREQ16			(628000)	/* KHz */
#define SEG_GPU_DVFS_FREQ17			(598000)	/* KHz */
#define SEG_GPU_DVFS_FREQ18			(569000)	/* KHz */
#define SEG_GPU_DVFS_FREQ19			(540000)	/* KHz */
#define SEG_GPU_DVFS_FREQ20			(512000)	/* KHz */
#define SEG_GPU_DVFS_FREQ21			(493000)	/* KHz */
#define SEG_GPU_DVFS_FREQ22			(474000)	/* KHz */
#define SEG_GPU_DVFS_FREQ23			(456000)	/* KHz */
#define SEG_GPU_DVFS_FREQ24			(436000)	/* KHz */
#define SEG_GPU_DVFS_FREQ25			(415000)	/* KHz */
#define SEG_GPU_DVFS_FREQ26			(396000)	/* KHz */
#define SEG_GPU_DVFS_FREQ27			(376000)	/* KHz */
#define SEG_GPU_DVFS_FREQ28			(357000)	/* KHz */
#define SEG_GPU_DVFS_FREQ29			(337000)	/* KHz */
#define SEG_GPU_DVFS_FREQ30			(317000)	/* KHz */
#define SEG_GPU_DVFS_FREQ31			(299000)	/* KHz */

#define SEG_GPU_DVFS_VOLT_OC		(100000)	/* mV x 100 */
...
#define SEG_GPU_DVFS_VSRAM_OC		(110000)	/* mV x 100 */
 ...
 * PMIC Setting
 **************************************************/
#define VGPU_MAX_VOLT		(SEG_GPU_DVFS_VOLT_OC)
#define VSRAM_GPU_MAX_VOLT	(SEG_GPU_DVFS_VSRAM_OC)
#define DELAY_FACTOR		(625)
#define BUCK_DIFF_MAX		(25000)		/* mV x 100 */
#define BUCK_DIFF_MIN		(10000)		/* mV x 100 */
#define NUM_OF_OPP_IDX		(33)
 ...
 **************************************************/
#define GPU_ACT_REF_POWER			(2040)		/* mW  */
...
#define MT_GPUFREQ_BATT_OC_LIMIT_FREQ		(598000)	/* KHz */
#endif
...
#define MT_GPUFREQ_BATT_PERCENT_LIMIT_FREQ	(598000)	/* KHz */
#endif
...
#define MT_GPUFREQ_LOW_BATT_VOLT_LIMIT_FREQ	(598000)	/* KHz */
#endif
