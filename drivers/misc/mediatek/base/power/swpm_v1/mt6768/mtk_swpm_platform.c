...
static unsigned short ddr_opp_freq[NR_DDR_FREQ] = {800, 1200, 1600, 2000};
...
static struct aphy_pwr_data aphy_def_pwr_tbl[] = {
	[APHY_VCORE] = {
		.read_pwr = {
			...
			[DDR_OPP3] = { /* freq = 2000 */
				.bw = {365, 850, 1975, 2720, 9795},
				.coef = {4325, 7195, 10250, 11880, 19730},
			},
		},
		.write_pwr = {
			[DDR_OPP0] = { /* freq = 800 */
	...
	[APHY_VDDQ_0P6V] = {
		.read_pwr = {
			...
			[DDR_OPP3] = { /* freq = 2000 */
				.bw = {142, 710, 1420, 2840, 4260},
				.coef = {109, 392, 741, 848, 1146},
			},
		},
		.write_pwr = {
			[DDR_OPP0] = { /* freq = 800 */
			...
			[DDR_OPP3] = { /* freq = 2000 */
				.bw = {142, 710, 1420, 2840, 4260},
				.coef = {481, 2046, 3843, 7003, 9448},
			},
		},
		.coef_idle = {12, 12, 13, 14},
	},
	[APHY_VM_1P1V] = {
		.read_pwr = {
			[DDR_OPP0] = { /* freq = 800 */
		...
		.write_pwr = {
			...
			[DDR_OPP3] = { /* freq = 2000 */
				.bw = {142, 710, 1420, 2840, 4260},
				.coef = {419, 1359, 2272, 3212, 4050},
			},
		},
		.coef_idle = {55, 55, 55, 61},
	},
	[APHY_VIO_1P8V] = {
		.read_pwr = {
			[DDR_OPP0] = { /* freq = 800 */
