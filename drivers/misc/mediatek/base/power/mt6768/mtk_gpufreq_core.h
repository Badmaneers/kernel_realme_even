...
#define MT_GPUFREQ_BATT_OC_LIMIT_FREQ		(800000)	/* KHz */
#endif
...
#define MT_GPUFREQ_BATT_PERCENT_LIMIT_FREQ	(800000)	/* KHz */
#endif
...
#define MT_GPUFREQ_LOW_BATT_VOLT_LIMIT_FREQ	(800000)	/* KHz */
#endif
